...
const N = "has-[[data-card-action]:hover]:from-blue-50 has-[[data-card-action]:hover]:to-white dark:has-[[data-card-action]:hover]:from-blue-950 dark:has-[[data-card-action]:hover]:to-slate-800", y = {
  ...
  ({ className: d, variant: l = "main", icon: s, label: n, count: o, badge: g, bordered: u = !1, headerAction: c, stretch: h = !1, loading: b = !1, ...m }, f) => {
    ...
    return l === "main" ? /* @__PURE__ */ e(
      "div",
      {
        ...
        ...m,
        children: b ? /* @__PURE__ */ t("div", { className: "flex flex-col flex-1 justify-between", children: [
          ...
          /* @__PURE__ */ t("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ t("div", { className: "flex items-center gap-0.5", children: [
              ...
              /* @__PURE__ */ e("span", { className: a("text-xl tracking-[-0.2px]", r), children: n })
            ] }),
          ...
          /* @__PURE__ */ e("span", { className: a("text-[86px] font-heading font-normal tracking-[-2.58px] leading-none block max-w-full truncate text-right", r), children: o })
        ] })
      }
    ) : l === "sub" ? /* @__PURE__ */ e(
      "div",
      {
        ...
        children: b ? /* @__PURE__ */ t("div", { className: "flex flex-col flex-1 justify-between", children: [
          ...
          /* @__PURE__ */ t("div", { className: "flex items-end gap-2 min-w-0", children: [
            ...
            /* @__PURE__ */ e("span", { className: a("flex-1 text-[48px] font-heading font-normal tracking-[-1.44px] leading-none block min-w-0 truncate text-right", r), children: o })
          ] })
        ] })
      }
    ) : /* @__PURE__ */ e(
      "div",
      {
        ...
        className: a(v({ variant: l, stretch: h }), x, d),
        ...m,
        children: b ? /* @__PURE__ */ t("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ e(i, { width: 60, height: 14 }),
          ...
          /* @__PURE__ */ e("span", { className: a("text-base font-heading tracking-[-0.16px] min-w-0 truncate", r), children: o })
        ] })
      }
    );
  }
