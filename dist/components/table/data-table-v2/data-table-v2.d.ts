...
export declare function DataTableV2<T extends {
    id: string | number;
}>({ data, columns: rawColumns, headerGroups, sortState, onSortChange, multiSort, resizable, columnWidths, onColumnResize, columnReorderable, columnOrder, onColumnReorder, selectable, selectedIds, defaultSelectedIds, onSelectionChange, onRowClick, rowClassName, expandable, onCellChange, rowActions, loading, loadingMode, loadingContent, emptyMessage, rowReorderable, onRowReorder, filterState, defaultFilterState, onFilterChange, maxHeight, estimateRowHeight, className, }: DataTableV2Props<T>): import("react/jsx-runtime").JSX.Element;
