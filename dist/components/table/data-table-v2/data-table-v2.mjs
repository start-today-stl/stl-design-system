...
import { useSensors as Vt, useSensor as $t, PointerSensor as Bt, DndContext as Gt, closestCenter as At } from "@dnd-kit/core";
...
import { DRAG_HANDLE_COL_WIDTH as B, CHECKBOX_COL_WIDTH as T, EXPAND_COL_WIDTH as G, ROW_ACTIONS_WIDTH as A, DEFAULT_COL_WIDTH as Yt } from "./constants.mjs";
...
function _n({
  ...
  const p = L ? !1 : Ve, O = (a == null ? void 0 : a.showDelete) ?? !!(a != null && a.onRowDelete), qe = (a == null ? void 0 : a.showAdd) ?? !!(a != null && a.onRowAdd), Je = f(a == null ? void 0 : a.onRowDelete), q = f(a == null ? void 0 : a.onRowAdd), Qe = f(ze), J = f(Ke), Ye = f(Pe), Ze = f(c == null ? void 0 : c.expandedRowRender), et = f(_e), Q = f(g), tt = f(Ae), nt = f(u), rt = f(Te), st = f($e), ue = f(c == null ? void 0 : c.onExpandedChange), { orderedColumns: Y, handleColumnDragEnd: fe } = sn({
    columns: h,
    columnReorderable: N,
    columnOrder: Me,
    onColumnReorder: rt
  }), { getColumnWidth: ge, handleResizeStart: it, resizingKey: ot } = rn({
    resizable: R,
    columnWidths: D,
    onColumnResize: nt
  ...
  }) : Y, [Y, R, ge]), H = p ? B : 0, _ = H + (y ? T : 0) + (c ? G : 0), I = _ + (O ? A : 0), [me, lt] = s.useState({}), Ce = s.useCallback(
    ...
    [c, ue]
  ), M = on({ data: r, expandable: ct }), v = nn({ onCellChange: Ye }), { handleRowDragEnd: Se } = en({ data: r, onRowReorder: st }), { rowSpanMap: dt, getRowSpan: k } = ln({ data: r, rowGrouping: L }), z = Zt({ filterState: Be, defaultFilterState: Ge, onFilterChange: tt }), b = s.useMemo(
    () => C ?? [],
    [C]
  ), at = s.useCallback(
    (e) => {
  ...
  const ht = s.useCallback(
    ...
    [d, N]
  ), gt = Vt($t(Bt, un)), [ke, Z] = s.useState(null), mt = s.useCallback((e) => {
    ...
    [fe, Se]
  ), pt = s.useCallback(() => Z(null), []), yt = s.useMemo(
    () => ke === "row" ? { threshold: { x: 0, y: 0.2 } } : { threshold: { x: 0.2, y: 0 } },
    [ke]
  ), vt = s.useMemo(
    () => p ? r.map((e) => `row-${e.id}`) : [],
    [r, p]
  ), [Ee, St] = s.useState(/* @__PURE__ */ new Map()), wt = s.useCallback((e, n) => {
    St((t) => {
    ...
    return e;
  }, [r, Ee, he]), Rt = K[r.length], [ee, kt] = s.useState(null), P = s.useMemo(() => ee === null ? -1 : r.findIndex((e) => e.id === ee), [ee, r]), Et = s.useCallback(
    (e, n) => {
      if (P < 0) return !1;
      const t = k(e, n);
    ...
    [P, k]
  ), xe = x.selectedSet, xt = s.useCallback(
    (e, n) => {
      const t = k(e, n);
    ...
    [k, r, xe]
  ), bt = s.useCallback(() => !1, []), Wt = L ? xt : bt, te = s.useRef(K);
  te.current = K;
  const Dt = s.useCallback(
    (e, n) => {
      const t = k(e, n);
      if (!(t === void 0 || t <= 1))
    ...
    [k]
  ), F = s.useRef(null), Nt = s.useCallback(
    (e) => {
      var n;
    ...
    getItemKey: Nt
  }), ne = s.useRef(/* @__PURE__ */ new Map()), Mt = s.useCallback(
    (e, n) => {
  ...
  s.useLayoutEffect(() => {
    for (const e of We) {
      ...
      if (!t) continue;
      const i = `${Math.round(j ? Ot(e) : K[e])}px`;
  ...
  s.useLayoutEffect(() => {
    ...
    const t = {};
    n.forEach((i) => {
      const l = i.dataset.columnKey;
      l && (t[l] = i.getBoundingClientRect().width);
    }), lt((i) => {
      const l = Object.keys(t);
      return l.length === Object.keys(i).length && l.every((W) => Math.abs((i[W] ?? -1) - t[W]) < 0.5) ? i : t;
    });
  }, [d, D, S]), s.useEffect(() => {
    const e = F.current;
    if (!e) return;
    const n = () => {
      const i = e.scrollLeft > 0, l = e.scrollLeft + e.clientWidth < e.scrollWidth - 1;
      e.dataset.scrolledLeft = i ? "true" : "false", e.dataset.scrolledRight = l ? "true" : "false", Tt(e.clientWidth);
    };
  ...
  const E = s.useMemo(
    ...
    let t = 0;
    for (; t < E.length; ) {
      const i = E[t], l = e.get(i.accessorKey);
      if (!l) {
        n.push({
          kind: "placeholder",
      ...
      for (; t < E.length && e.get(E[t].accessorKey) === l; ) {
        const $ = E[t];
        typeof $.width == "number" ? (V += $.width, ie += $.width) : (W += 1, ie += U($)), t += 1;
      }
      n.push({
        // 같은 그룹이 여러 구간으로 갈라질 수 있으므로 key 는 구간 첫 컬럼 기준
        key: `group-${String(E[Ft].accessorKey)}`,
        kind: "group",
        width: W === 0 ? V : void 0,
        flexGrow: W,
  ...
  }, [d]), Pt = d.length + (p ? 1 : 0) + (y ? 1 : 0) + (c ? 1 : 0) + (O ? 1 : 0), Ie = /* @__PURE__ */ o(
    "div",
    {
      role: "grid",
      ...
      children: /* @__PURE__ */ o(
        "div",
        {
          ...
          children: /* @__PURE__ */ oe("div", { style: { minWidth: ve }, children: [
            /* @__PURE__ */ o(
              Qt,
              {
                columns: d,
            ...
            de ? ae ? (
              ...
              /* @__PURE__ */ o("div", { children: Array.from({ length: hn }).map((e, n) => /* @__PURE__ */ oe(
                "div",
                {
                  role: "row",
                  ...
                  children: [
                    ...
                    y && /* @__PURE__ */ o(
                      "div",
                      {
                        ...
                        style: { width: T },
                        children: /* @__PURE__ */ o(ce, { width: 16, height: 16 })
                      }
                    ),
                    c && /* @__PURE__ */ o(
                      "div",
                    ...
                    d.map((t) => {
                      const i = typeof t.width == "number" ? t.width : void 0, l = typeof t.minWidth == "number" ? t.minWidth : void 0;
                      return /* @__PURE__ */ o(
                        "div",
                        {
                          role: "gridcell",
                          ...
                          style: { width: i, minWidth: l },
                          children: /* @__PURE__ */ o(ce, { height: 16, width: "70%" })
                        },
              ...
              /* @__PURE__ */ o(
                "div",
                {
                  className: "sticky left-0 flex items-center justify-center min-h-64 py-8",
                  style: S ? { width: S } : void 0,
                  children: /* @__PURE__ */ o(qt, { size: "lg" })
                }
              )
                    ...
                    const e = We.map((n) => {
                      ...
                      return /* @__PURE__ */ o(
                        tn,
                        {
                          ...
                          expandedRowRender: c ? Ze : void 0,
                          expandColWidth: G,
                          visibleWidth: S,
                          onRowClick: Qe,
                          extraClassName: J == null ? void 0 : J(t),
                          editingColumnKey: ((i = v.editing) == null ? void 0 : i.rowId) === t.id ? v.editing.columnKey : null,
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ o(
                        "button",
                        {
                          ...
                          "aria-label": "행 추가",
                          children: /* @__PURE__ */ o(Jt, { size: 20 })
                        }
                      )
                    }
                  ),
