  ...
  "inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors rounded-[4px] p-[5px] text-[10px] tracking-[-0.15px]",
  {
    variants: {
      variant: {
        ...
        "neutral-light": "bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200",
        // 상태 표시용 - Solid (진한 배경)
        ...
        "neutral-solid": "bg-slate-500 text-white dark:bg-slate-600",
        ...
        "neutral-outline": "border border-slate-400 bg-slate-100/30 text-slate-700 dark:border-slate-500 dark:bg-slate-500/20 dark:text-slate-200"
      }
    },
    defaultVariants: {
...
function i({ className: e, variant: r, ...t }) {
  return /* @__PURE__ */ a("div", { className: l(b({ variant: r }), e), ...t });
}
export {
  i as Badge,
  b as badgeVariants
