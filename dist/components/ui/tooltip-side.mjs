...
import { Content as f } from "../../node_modules/@radix-ui/react-tooltip/dist/index.mjs";
import { cn as i } from "../../lib/utils.mjs";
const b = d.forwardRef(({ className: t, sideOffset: e = 4, ...r }, a) => /* @__PURE__ */ o(
  f,
  {
    ref: a,
    sideOffset: e + 14,
    className: i(
      ...
      // Top arrow
      "data-[side=top]:after:left-1/2 data-[side=top]:after:top-full data-[side=top]:after:-ml-[10px] data-[side=top]:after:border-t-white data-[side=top]:after:border-t-[18px] dark:data-[side=top]:after:border-t-[#2f3542]",
      ...
      // Bottom arrow
      "data-[side=bottom]:after:bottom-full data-[side=bottom]:after:left-1/2 data-[side=bottom]:after:-ml-[10px] data-[side=bottom]:after:border-b-white data-[side=bottom]:after:border-b-[18px] dark:data-[side=bottom]:after:border-b-[#2f3542]",
      ...
      // Left arrow
      "data-[side=left]:after:left-full data-[side=left]:after:top-1/2 data-[side=left]:after:-mt-[10px] data-[side=left]:after:border-l-white data-[side=left]:after:border-l-[18px] dark:data-[side=left]:after:border-l-[#2f3542]",
      ...
      // Right arrow
      "data-[side=right]:after:right-full data-[side=right]:after:top-1/2 data-[side=right]:after:-mt-[10px] data-[side=right]:after:border-r-white data-[side=right]:after:border-r-[18px] dark:data-[side=right]:after:border-r-[#2f3542]",
