const Pe = (e, t) => {
  ...
  t.validators === null && (t.validators = []), t.validators.push(Ge(o, e));
}, _e = (e, t, o, r) => {
  ...
  for (let d = 0; d < i; d++) {
    ...
    u || (u = we(), o.nextPart.set(a, u)), o = u;
  }
  return o;
}, We = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, Be = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  if (t) {
    const i = t + fe, d = r;
    r = (a) => a.startsWith(i) ? d(a.slice(i.length)) : be($e, !1, a, void 0, !0);
  }
  if (o) {
    const i = r;
    r = (d) => o({
  ...
  for (let f = u.length - 1; f >= 0; f -= 1) {
    ...
    let x = !!v, P = r(x ? M.substring(0, v) : M);
    if (!P) {
      if (!x) {
        c = h + (c.length > 0 ? " " + c : c);
        continue;
  ...
  const a = (c) => {
    ...
    return o = Ye(f), r = o.cache.get, i = o.cache.set, d = u, u(c);
  }, u = (c) => {
    const f = r(c);
    if (f)
      return f;
...
}, ve = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, ze = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Qe = /^\d+\/\d+$/, Ze = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, eo = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, oo = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, ro = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, to = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, N = (e) => Qe.test(e), p = (e) => !!e && !Number.isNaN(Number(e)), R = (e) => !!e && Number.isInteger(Number(e)), oe = (e) => e.endsWith("%") && p(e.slice(0, -1)), S = (e) => Ze.test(e), so = () => !0, no = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  eo.test(e) && !oo.test(e)
), Ce = () => !1, ao = (e) => ro.test(e), io = (e) => to.test(e), lo = (e) => !s(e) && !n(e), co = (e) => V(e, Re, Ce), s = (e) => ve.test(e), O = (e) => V(e, Ie, no), re = (e) => V(e, bo, p), ge = (e) => V(e, Ae, Ce), mo = (e) => V(e, Se, io), J = (e) => V(e, Me, ao), n = (e) => ze.test(e), B = (e) => F(e, Ie), po = (e) => F(e, go), he = (e) => F(e, Ae), uo = (e) => F(e, Re), fo = (e) => F(e, Se), H = (e) => F(e, Me, !0), V = (e, t, o) => {
  const r = ve.exec(e);
  return r ? r[1] ? t(r[1]) : o(r[2]) : !1;
}, F = (e, t, o = !1) => {
  const r = ze.exec(e);
  return r ? r[1] ? t(r[1]) : o : !1;
}, Ae = (e) => e === "position" || e === "percentage", Se = (e) => e === "image" || e === "url", Re = (e) => e === "length" || e === "size" || e === "bg-size", Ie = (e) => e === "length", bo = (e) => e === "number", go = (e) => e === "family-name", Me = (e) => e === "shadow", ho = () => {
  const e = b("color"), t = b("font"), o = b("text"), r = b("font-weight"), i = b("tracking"), d = b("leading"), a = b("breakpoint"), u = b("container"), c = b("spacing"), f = b("radius"), h = b("shadow"), y = b("inset-shadow"), z = b("text-shadow"), I = b("drop-shadow"), M = b("blur"), v = b("perspective"), x = b("aspect"), P = b("ease"), $ = b("animate"), _ = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], j = () => [
    "center",
    "top",
    "bottom",
    "left",
...
export {
  He as createTailwindMerge,
  b as fromTheme,
  ho as getDefaultConfig,
  Je as twJoin,
  wo as twMerge
};
//# sourceMappingURL=index140.mjs.map
