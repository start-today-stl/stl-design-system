...
import { Root as k, Trigger as y, Value as w, Icon as v, Portal as N, Content as z, Viewport as I, Item as R, ItemText as _ } from "./index121.mjs";
import { cn as t } from "./index105.mjs";
import { DownIcon as j } from "./index27.mjs";
const C = {
  sm: "w-[160px]",
  md: "w-[260px]",
  lg: "w-[360px]",
  ...
  ({
    ...
    const s = i.useId();
    return /* @__PURE__ */ d("div", { className: t("flex flex-col gap-1", C[b], u), children: [
      o && /* @__PURE__ */ e(
        "label",
        {
          htmlFor: s,
