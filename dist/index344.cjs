"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const f=require("react"),b=require("./index345.cjs"),o=require("./index335.cjs"),p=require("./index378.cjs");function v(t){const c=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(t){for(const e in t)if(e!=="default"){const n=Object.getOwnPropertyDescriptor(t,e);Object.defineProperty(c,e,n.get?n:{enumerable:!0,get:()=>t[e]})}}return c.default=t,Object.freeze(c)}const u=v(f);var m=b.styleSingleton(),r="data-scroll-locked",h=function(t,c,e,n){var i=t.left,l=t.top,d=t.right,a=t.gap;return e===void 0&&(e="margin"),`
