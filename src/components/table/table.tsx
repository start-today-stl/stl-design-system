...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("h-9 pl-3 pr-1.5 py-1.5 align-middle text-slate-800 dark:text-slate-200 [&:has([role=checkbox])]:pr-0 border-b border-slate-200 dark:border-slate-700", className)}
    {...props}
  />
))
