...
const maxWidthClasses: Record<PageTabMaxWidth, string> = {
  60: "max-w-[60px]",
  80: "max-w-[80px]",
  100: "max-w-[100px]",
  120: "max-w-[120px]",
...
const minWidthClasses: Record<PageTabMinWidth, string> = {
  40: "min-w-[40px]",
  60: "min-w-[60px]",
  80: "min-w-[80px]",
}
...
/** 드래그 가능한 탭 리스트 Props */
export interface PageTabsSortableListProps
  extends React.ComponentPropsWithoutRef<typeof TabsPrimitive.List> {
  /** 탭 정렬 위치 */
  align?: "start" | "end"
  /** 탭 ID 배열 (순서대로) */
...
const PageTabsSortableList = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.List>,
  PageTabsSortableListProps
...
PageTabsSortableList.displayName = "PageTabsSortableList"
...
/** 드래그 앤 드롭 가능한 탭 트리거 */
const PageTabsSortableTrigger = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.Trigger>,
  PageTabsSortableTriggerProps
...
PageTabsSortableTrigger.displayName = "PageTabsSortableTrigger"
