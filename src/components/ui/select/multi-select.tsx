...
/** "선택 없음" 을 나타내는 고정 배열 — 매 렌더 새 배열을 만들면 하위 memo 가 깨진다 */
...
>(
  (
    ...
    const currentValue = wasControlledRef.current ? (value ?? EMPTY_VALUES) : internalValue;
    // 선택 순서 유지 — currentValue 배열 순서대로 chip 렌더.
